...
`https://microsoft-translator-text.p.rapidapi.com/translate?to%5B0%5D=${outputFormat}&api-version=3.0&profanityAction=NoAction&textType=plain`; 
	...
	return ( 
        ...
        <img src='https://logos-world.net/wp-content/uploads/2022/05/Google-Translate-Symbol.png' className='logo'></img>
			<div className="row1"> 
...
"M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"> 
                ...
                <button className='copy-btn' onClick={handleCopyText}>
                    {copied ? <i class="fa-solid fa-clipboard-check"></i> : <i class="fa-regular fa-clipboard"></i>}
